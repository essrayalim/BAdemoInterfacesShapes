...
namespace InterfacesShapes
{
    public partial class Form1 : Form
    {
        ...
        {
            pDiger.Location = new Point(12, 36);
            pHesap.Location = new Point(12, 151);
            this.Size = new Size(446, 303);
        ...
        private void bHesapla_Click(object sender, EventArgs e)
        {
            ...
            if (rbDaire.Checked)
            {
                ...
                sonuc = ddlIslem.SelectedIndex == 0 ? roundedShape.CalculateArea()
                    : roundedShape.CalculateCircumference();
            }
            else if (rbDortgen.Checked)
            {
                ...
                sonuc = ddlIslem.SelectedIndex == 0 ? shapeWithAngles.CalculateArea() :
                    shapeWithAngles.CalculateCircumference();
            }
            else
            {
                ...
                {
                    MessageBox.Show("Genişlik sayısal olmalıdır!");
                    return;
                }
                if (!GirisKontrolEt2(tbYukseklik.Text))
                {
                    MessageBox.Show("Yükseklik sayısal olmalıdır!");
                    return;
                }
        ...
        bool GirisKontrolEt1(string giris) // Yahya'nın yolu
        {
